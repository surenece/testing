...
public class Can_Test extends Baseclass {
	...
	public void can_frm_test(String adhar, String appel, String sex, String name, String maritalsts, String DOB,
			String Relationship, String F_name, String M_name, String relgn, String cmunty, String wrk, String Dis,
			String Tal, String village, String St_name, String Stname_tn, String door_no, String pin, String ph) {

		try {
			can_num = can_frm.appl_details(adhar, appel, sex, name, maritalsts, DOB, Relationship, F_name, M_name,
					relgn, cmunty, wrk, Dis, Tal, village, St_name, Stname_tn, door_no, pin, ph);
